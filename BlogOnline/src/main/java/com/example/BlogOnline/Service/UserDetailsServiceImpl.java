package com.example.BlogOnline.Service;
...
public class UserDetailsServiceImpl  implements UserDetailsService {
        ...
        public UserDetails loadUserByUsername (String username) throws UsernameNotFoundException {
            ...
            //tenemos Usuario sec y necesitamos devolver UserDetails
    ...
    public Object loginOAuthUser(@Valid AuthLoginRequestDTO userRequest) {
        //recuperamos nombre de usuario y contraseña
        String username = userRequest.username();

        Authentication authentication = this.authenticateOAuth2Users (username);
    ...
    public Authentication authenticateOAuth2Users (String username) {
        //con esto debo buscar el usuario
        UserDetails userDetails = this.loadUserByUsername(username);
